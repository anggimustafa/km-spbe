    ...
    <div class="container-fluid">
        <div class="col-lg-11 shadow p-5 rounded" style="margin:auto">
            ...
            {{-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                Pilih Author untuk join ke thread
            </button> --}}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Author for join thread</h1>
                    ...
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td><a title="Lihat" href="/dashboard/unverify/{{ $post->slug }}"><i
                                ...
                                <a title="Verifikasi" href=""><i
                                        class="fa-solid fa-circle-check"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a title="Hapus" href=""><i class="fa-solid fa-delete-left"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
